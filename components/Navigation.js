  ...
  return (
    ...
    <div>
      ...
      <nav className='flex items-center flex-wrap p-3  bg-gradient-to-r from-purple-500 to-pink-500'>
        ...
        <div className={` w-full lg:w-auto lg:inline-flex flex-grow  ${navbar? 'block' : 'hidden'}`}>
          <div className='lg:inline-flex lg:flex-row lg:ml-auto  lg:w-auto w-full lg:h-auto flex flex-col'>
            <Link href='/'>
              <a className=' px-3 py-2 w-auto hover:text-slate-200  text-white font-bold'>
                Home
              </a>
            </Link>
            <Link href='/'>
              <a className='px-3 py-2 text-white font-bold  hover:text-slate-200 '>
                Services
              </a>
            </Link>
            <Link href='/'>
